...
const LinkTree = ({ data }) => {
    ...
    return (
        <section className='relative'>
            <img className='w-20 absolute rounded-full left-1/2 -translate-x-1/2 mt-2' src={avatar} alt='pro_image' />
            <h2 className='text-center text-lg font-bold pt-28'>{name ? name : 'Guest'}</h2>
